            ...
            using (NpgsqlConnection pgConn = new NpgsqlConnection(AppConfig.connectionString))
            {
                ...
                using (NpgsqlDataReader reader = await selectComm.ExecuteReaderAsync())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        projectFeatureFromDb.properties.sksNo = reader.IsDBNull(reader.GetOrdinal("sks_no"))
                            ? (long?)null
                            : reader.GetInt64(reader.GetOrdinal("sks_no"));                         
                        ...
                        projectFeatureFromDb.properties.workingTitle = reader.IsDBNull(reader.GetOrdinal("working_title"))
                            ? ""
                            : reader.GetString(reader.GetOrdinal("working_title"));
                        projectFeatureFromDb.properties.implementationByThird = reader.IsDBNull(reader.GetOrdinal("implementation_by_third"))
                            ? false
                            : reader.GetBoolean(reader.GetOrdinal("implementation_by_third"));
        ...
        public ActionResult<RoadWorkActivityFeature> AddActivity([FromBody] RoadWorkActivityFeature roadWorkActivityFeature)
        {
            try
            {
                ...
                using (NpgsqlConnection pgConn = new NpgsqlConnection(AppConfig.connectionString))
                {
                    ...
                    insertComm.Parameters.AddWithValue("projecttype", roadWorkActivityFeature.properties.projectType == "" ? DBNull.Value : roadWorkActivityFeature.properties.projectType);
                    insertComm.Parameters.AddWithValue("projectkind", roadWorkActivityFeature.properties.projectKind == "" ? DBNull.Value : roadWorkActivityFeature.properties.projectKind);           
                    insertComm.Parameters.AddWithValue("working_title", roadWorkActivityFeature.properties.workingTitle ?? (object)DBNull.Value);
                    insertComm.Parameters.AddWithValue("implementation_by_third", roadWorkActivityFeature.properties.implementationByThird);
                    ...
                    insertComm.Parameters.AddWithValue("sks_no", roadWorkActivityFeature.properties.sksNo != null ? roadWorkActivityFeature.properties.sksNo : DBNull.Value);
        ...
        public ActionResult<RoadWorkActivityFeature> UpdateActivity([FromBody] RoadWorkActivityFeature roadWorkActivityFeature)
        {
            try
            {
                ...
                using (NpgsqlConnection pgConn = new NpgsqlConnection(AppConfig.connectionString))
                {
                    ...
                    updateComm.Parameters.AddWithValue("sks_no", roadWorkActivityFeature.properties.sksNo != null ? roadWorkActivityFeature.properties.sksNo : DBNull.Value);
                    ...
                    updateComm.Parameters.AddWithValue("working_title", roadWorkActivityFeature.properties.workingTitle ?? (object)DBNull.Value);
                    updateComm.Parameters.AddWithValue("implementation_by_third", roadWorkActivityFeature.properties.implementationByThird);
